...
class ConversationalRecipeBot:
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        if api_key and OPENAI_AVAILABLE:
            try:
                self.openai_client = OpenAI(api_key="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")
                # Test the connection
